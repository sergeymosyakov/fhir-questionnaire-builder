...
description: "FHIR field/extension/SDC support conventions for the Questionnaire Builder — mandatory FHIR tooltips, keeping docs/FHIR-MAPPING.md, help.html, GitHub issues labeled roadmap, and sampledata/ in sync, and two-layer preview validation. Use when adding, removing, or changing any FHIR mapping, extension, or SDC feature."
---
...
- **Implemented = close the roadmap issue.** The feature backlog lives as GitHub issues labeled `roadmap`, not a file. Once a roadmap item is fully implemented, close its issue (reference `Closes #<n>` in the PR) instead of editing a backlog file.
