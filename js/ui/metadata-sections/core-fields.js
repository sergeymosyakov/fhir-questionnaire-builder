...
class CoreFieldsSection extends Section {
  build(pending) {
    ...
    frag.append(
      ...
      r('url',         'URL',         'text',     'http://example.org/fhir/\u2026', 'meta-url',    { title: 'Questionnaire.url',         body: 'Canonical URL \u2014 globally unique identifier for this questionnaire. Used for cross-server references, versioning, and profile conformance declarations.',  fhir: 'Questionnaire.url',         spec: 'R4' }),
