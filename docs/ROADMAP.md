...
- [x] **Population ($populate)** — `Answers ▾ → Fill from FHIR Server` sends `POST Questionnaire/$populate` to configured SDC Server. Requires a server implementing SDC IG (e.g. Matchbox). See Settings → SDC Server.
