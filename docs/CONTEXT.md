...
| `js/ui/menus/more-menu.js` | `MoreMenu extends DropdownMenu` — `⋯` button in builder header; contains Undo, Redo (with `data-mount` for `UndoRedo`), separator, FHIR Reference (opens `HelpModal`), Settings (opens `settings.html`) |
