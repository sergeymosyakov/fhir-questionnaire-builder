...
- **Vitest** — unit test suite for pure-function modules; **685 tests** across 13 files; CDN imports mocked via `vi.mock`; CI via GitHub Actions (`npm test`)
