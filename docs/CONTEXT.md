...
- **Playwright** — E2E test suite; **557 tests** across 33 spec files (Chromium); CI via GitHub Actions (`npx playwright test`)
...
- **Vitest** — unit test suite for pure-function modules; **747 tests** across 14 files; CDN imports mocked via `vi.mock`; CI via GitHub Actions (`npm test`)
