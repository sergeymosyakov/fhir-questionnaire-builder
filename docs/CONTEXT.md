...
- **Playwright** — E2E test suite; 135 spec files (Chromium); CI via GitHub Actions (`npx playwright test`)
...
- **Vitest** — unit test suite for pure-function modules; **1899 tests** across 57 files; CI via GitHub Actions (`npm test`)
