...
Stored in `questDoc.meta` (`js/fhir/quest-document.js`). Populated on import, written back on export, editable via the Properties modal. Reset to defaults when the questionnaire is cleared.
