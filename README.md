...
- **Expression Explain** — click a checkbox calc-badge to open a centered popup that breaks the FHIRPath expression into an AND/OR/NOT/LEAF tree and shows ✓/✗ next to each node; hover first to see the "Click to explain." tooltip
